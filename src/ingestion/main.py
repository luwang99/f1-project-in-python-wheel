...
def main():
  ...
  spark = SparkSession.builder \
      .appName(appName) \
      .getOrCreate()  #spark sessions. Databricks has spark session pre defined, so we don't need to write it by ourselves. But this package may not run in Databricks only, so we need to define
